          ...
          <div>
            ...
            <div class="mt-2 text-sm text-gray-600">
              ...
              <ul class="list-disc list-inside space-y-1">
                <li :class="passwordCriteria.length ? 'text-green-600' : 'text-red-600'">
                  At least 8 characters
                </li>
                <li :class="passwordCriteria.hasLetter ? 'text-green-600' : 'text-red-600'">
                  At least 1 letter
                </li>
                <li :class="passwordCriteria.hasNumber ? 'text-green-600' : 'text-red-600'">
                  At least 1 number
                </li>
                <li :class="passwordCriteria.hasSpecial ? 'text-green-600' : 'text-red-600'">
